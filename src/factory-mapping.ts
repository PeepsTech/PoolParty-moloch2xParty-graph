...
import { createAndApproveToken, createEscrowTokenBalance, createGuildTokenBalance, createAndAddSummoner, createAndAddSummoner2, createAndAddWETHSummoner, createAndAddWETHSummoner2, createAndAddNOFISummoner} from "./v2-mapping"
...
export function handleSummoned2(event: PartyStarted2): void {
  ...
  for (let i = 0; i < eventFounders.length; i++) {
    let founder = eventFounders[i];
      founders.push(
        createAndAddSummoner2(molochId, founder, event)
      );
    }
...
export function handleWETHSummoned(event: WETHPartyStarted): void {
  ...
  moloch.depositToken = approvedTokens[0];
  moloch.idleToken = approvedTokens[0];
  ...
  for (let i = 0; i < eventFounders.length; i++) {
    let founder = eventFounders[i];
      founders.push(
        createAndAddWETHSummoner(molochId, founder, event)
      );
    }
...
export function handleWETHSummoned2(event: WETHPartyStarted2): void {
  ...
  for (let i = 0; i < eventFounders.length; i++) {
    let founder = eventFounders[i];
      founders.push(
        createAndAddWETHSummoner2(molochId, founder, event)
      );
    }
...
export function handleNOFISummoned(event: NOFIPartyStarted): void {
  ...
  for (let i = 0; i < eventFounders.length; i++) {
    let founder = eventFounders[i];
      founders.push(
        createAndAddNOFISummoner(molochId, founder, event)
      );
    }
